...
<div class="layout">
  ...
  <main class="main" id="main" tabindex="-1">
    <div class="view active" id="view-article-edit">
      ...
      if ((string)($article['status'] ?? '') === 'published' && !empty($article['slug'])) {
          $actions .= ' <a href="/writing/' . $e((string)$article['slug']) . '" target="_blank" rel="noopener" class="btn-sec">Live ↗</a>';
      }
      ...
      <?php if ($showPreviewTab): ?>
        <div class="cms-tabs" role="tablist" aria-label="Article edit and preview">
