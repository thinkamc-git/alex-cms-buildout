...
?>
<div class="content-block is-collapsible <?= $sid > 0 ? 'is-collapsed' : '' ?>" data-section data-section-type="<?= $e($stype) ?>">
  <input type="hidden" name="<?= $inputBase ?>[id]"   value="<?= (int)$sid ?>">
  <input type="hidden" name="<?= $inputBase ?>[type]" value="<?= $e($stype) ?>">

  <div class="content-block-header" data-collapse-toggle style="cursor:pointer;align-items:center;display:flex;gap:var(--space-12)">
    ...
    <div style="display:flex;gap:var(--space-4);align-items:center;flex-shrink:0;margin-left:auto" onclick="event.stopPropagation()">
  ...
  <div class="content-block-body" style="padding:var(--space-20) var(--space-24)">

<?php if ($stype === 'hero'): ?>
    <div class="field-group sec-title-field">
      <label class="field-label">Section title <span class="field-hint-inline" style="font-family:var(--font-mono);font-size:var(--text-micro);font-weight:400;letter-spacing:0;text-transform:none;color:var(--muted)">optional</span></label>
    ...
    <div class="field-group" style="margin-bottom:0">
      <label class="field-label">Pick a post</label>
...
<?php elseif ($stype === 'curated'): ?>
    <div class="form-grid" style="grid-template-columns: 280px minmax(0,1fr)">
      ...
      <div class="form-side">
        ...
        <div class="field-group">
          <label class="field-label">Trailing Card Label <span class="field-hint-inline" style="font-family:var(--font-mono);font-size:var(--text-micro);font-weight:400;letter-spacing:0;text-transform:none;color:var(--muted)">i.e. See More</span></label>
          <input type="text" class="field-input" name="<?= $inputBase ?>[see_more_label]" placeholder="See more" value="<?= $e($seeLab) ?>">
        </div>
        <div class="field-group" style="margin-bottom:0">
          <label class="field-label">Trailing Card URL</label>
...
<?php else: /* feed */ ?>
    <div class="form-grid-3">
      ...
      <!-- Col 2 — Content Query -->
      <div>
        <div class="content-block-label" style="margin-bottom:var(--space-12);letter-spacing:0.16em">Content Query <span class="field-hint-inline" style="font-family:var(--font-mono);font-size:var(--text-micro);font-weight:400;letter-spacing:0;text-transform:none;color:var(--muted)">never shown to visitors</span></div>
        <div class="field-group">
      ...
      <div>
        ...
        <div data-filter-detail style="<?= $fshow ? '' : 'display:none' ?>">
          <div class="field-group">
            <label class="field-label">Type Filters <span class="field-hint-inline" style="font-family:var(--font-mono);font-size:var(--text-micro);font-weight:400;letter-spacing:0;text-transform:none;color:var(--muted)">selectable by visitors</span></label>
            <div class="filter-bar" style="padding:0;background:transparent;border-bottom:none;flex-wrap:wrap">
              <div class="filter-group">
                <?php foreach ($typeLabels as $slug => $label):
          ...
          <div class="field-group" style="margin-bottom:0">
            <label class="field-label">Category Filters <span class="field-hint-inline" style="font-family:var(--font-mono);font-size:var(--text-micro);font-weight:400;letter-spacing:0;text-transform:none;color:var(--muted)">based on selected types</span></label>
            <div class="filter-bar" style="padding:0;background:transparent;border-bottom:none;flex-wrap:wrap">
              <div class="filter-group">
                <?php foreach ($catsForThis as $cat):
                    $cslug = (string)$cat['value_slug'];
